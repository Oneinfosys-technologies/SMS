    ...
    public function getContacts(array $params = [])
    {
        ...
        if ($studentAudienceType == 'all') {
            $students = Student::query()
                ...
                ->get();
        } else if ($studentAudienceType == 'division_wise') {
            $divisions = Division::query()
                ->byPeriod()
            ...
            $students = Student::query()
                ...
                ->get();
        } else if ($studentAudienceType == 'course_wise') {
            $courses = Course::query()
                ->byPeriod()
                ->whereIn('id', $studentAudiences)
                ->get();
            ...
            $students = Student::query()
                ...
                ->get();
        } else if ($studentAudienceType == 'batch_wise') {
            $batches = Batch::query()
                ->byPeriod()
                ->whereIn('id', $studentAudiences)
                ->get();
        ...
        if ($employeeAudienceType == 'all') {
            $employees = Employee::query()
                ...
                ->get();
        } else if ($employeeAudienceType == 'department_wise') {
            $departments = Department::query()
                ->byTeam()
            ...
            $employees = Employee::query()
                ...
                ->get();
        } else if ($employeeAudienceType == 'designation_wise') {
            $designations = Designation::query()
                ->byTeam()
                ->whereIn('id', $employeeAudiences)
                ->get();
