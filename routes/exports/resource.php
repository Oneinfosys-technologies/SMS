...
use App\Http\Controllers\Resource\Report\DateWiseStudentDiaryExportController;
...
Route::prefix('resource')->name('resource.')->group(function () {
    ...
    Route::get('reports/date-wise-student-diary/export', DateWiseStudentDiaryExportController::class)->middleware('permission:resource:report')->name('student.reports.date-wise-student-diary.export');
});
